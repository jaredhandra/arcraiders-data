export const rotaryEncoder = {
    "name": {
        ...
        "de": "Drehgeber",
        "fr": "Encodeur Rotatif",
        "es": "Codificador rotatorio",
        "pt": "Codificador rotativo",
        "pl": "Enkoder obrotowy",
        "no": "Rotasjonsenkoder",
        "da": "Roterende encoder",
        "it": "Encoder rotativo",
        "ja": "ロータリーエンコーダー",
        "kr": "로터리 엔코더",
        "zh-CN": "旋转编码器",
        "zh-TW": "旋轉編碼器",
        "ru": "Поворотный энкодер",
        "tr": "Döner Kodlayıcı",
        "uk": "Поворотний енкодер",
        "sr": "Rotacioni enkoder",
        "hr": "Rotacijski enkoder"
    },
    "description": {
        ...
        "zh-CN": "可以回收为制作材料。",
        "zh-TW": "可以回收為製作材料。",
        "ru": "Можно переработать в крафтовые материалы.",
...
//# sourceMappingURL=rotary_encoder.js.map