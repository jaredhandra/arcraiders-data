// AUTO-GENERATED from items/rocketeer_driver.json — do not edit
import type { Item } from '../common';

export const rocketeerDriver: Item = {
  "id": "rocketeer_driver",
  "name": {
    "en": "Rocketeer Driver",
    "de": "Raketenkanoniertreiber",
    "fr": "Pilote d'Artificier",
    "es": "Controlador de cohetero",
    "pt": "Driver de fogueteiro",
    "pl": "Napęd rakietowy",
    "no": "Rakettdriver",
    "da": "Raketdriver",
    "it": "Propulsore a razzo",
    "ru": "Драйвер Ракетчика",
    "ja": "ロケッティアドライバー",
    "zh-TW": "火箭兵驅動器",
    "uk": "Драйвер ракетника",
    "zh-CN": "火箭兵驱动器",
    "kr": "로켓티어 드라이버",
    "tr": "Roketçi Sürücüsü",
    "hr": "Raketni pogon",
...
export default rocketeerDriver;
